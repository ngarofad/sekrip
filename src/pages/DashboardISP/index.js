...
import { Footer, Chart, Deposits, Orders, mainListItemsDashISP, secondaryListItemsDashISP, SelectDateDashISP } from '../../components';
    ...
    return (
        <div className={classes.root}>
            ...
            >
                ...
                <Divider />
                <List>{mainListItemsDashISP}</List>
                <Divider />
                <List>{secondaryListItemsDashISP}</List>
            </Drawer>
